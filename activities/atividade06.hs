...
listMap function (Node node tail) = Node (function node) (listMap function tail)
...
listToStr Empty = ""
listToStr (Node node Empty) = show node
listToStr (Node node tail) = show node ++ ":" ++ listToStr tail
